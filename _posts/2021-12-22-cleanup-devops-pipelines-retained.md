...
![One or more builds associated with the requested pipeline(s) are retained by a release. The pipeline(s) and builds will not be deleted.](/images/devops-pipeline-retention-lease-error-onremoval.png)
