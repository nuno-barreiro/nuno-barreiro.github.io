...
![Error code EEXIST while trying to update NPM](/assets/images/npm-update-error-nvm-windows.png)
...
![Properties of the nodejs link in Program Files](/assets/images/nvm-install-path-nodejs-link.png)
