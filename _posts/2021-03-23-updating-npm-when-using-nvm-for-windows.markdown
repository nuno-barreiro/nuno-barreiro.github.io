...
![Error code EEXIST while trying to update NPM](/assets/images/_posts/npm-update-error-nvm-windows.png)
...
![Properties of the nodejs link in Program Files](/assets/images/_posts/nvm-install-path-nodejs-link.png)
