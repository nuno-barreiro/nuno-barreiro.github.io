...
![Error code EEXIST while trying to update NPM](/assets/images/posts/npm-update-error-nvm-windows.png){:class="img-fluid"}
...
![Properties of the nodejs link in Program Files](/assets/images/posts/nvm-install-path-nodejs-link.png){:class="mx-auto d-block"}
